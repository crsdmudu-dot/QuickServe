...
|---|---|---|---|
| iOS app | EAS Build | native binary (bundle id `ke.co.hiredcorp.kwikserve`) | `eas.json`, `app.json` |
| Android app | EAS Build | APK (dev/preview) / production build (package `ke.co.hiredcorp.kwikserve`) | `eas.json`, `app.json` |
