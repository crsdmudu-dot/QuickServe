/**
 * src/app/customers/index.tsx — Web Admin Customers List (read-only)
 *
 ...
 *
 * Wrapped by AdminShell via the _layout.tsx — this screen only
    ...
    },
    {
      ...
      render: (row) => (
        <Button
          ...
          onPress={() =>
            router.push(
              `/operations/new?customer_id=${row.id}` as Href,
            )
          }
        />
      ),
