/**
 * src/app/analytics/detailed.tsx — Web Admin Detailed Analytics Dashboard.
 *
 ...
 *
 * Wrapped by AdminShell via _layout.tsx — returns only content.
...
import { PieChart, type PieSlice } from '@admin/components/charts/pie-chart';
import { TrendCard } from '@admin/components/charts/trend-card';
