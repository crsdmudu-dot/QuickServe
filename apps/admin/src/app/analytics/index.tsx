 ...
 *   - Drill-down button → /analytics/detailed  (Slice-25 dashboard)
...
import { BarChart, type BarDatum } from '@admin/components/charts/bar-chart';
import { LineChart, type SeriesPoint } from '@admin/components/charts/line-chart';
...
import { ExecutiveKpiCard } from '@admin/components/analytics/executive-kpi-card';
import { MetricSection } from '@admin/components/analytics/metric-section';
import { ExportMenu } from '@admin/components/analytics/export-menu';
...
import { GrowthDeltaBadge } from '@admin/components/analytics/growth-delta-badge';
import {
    ...
    <>
      ...
      <View style={styles.header}>
        ...
        <Button
          ...
          onPress={() => router.push('/analytics/detailed' as Href)}
          variant="secondary"
          size="md"
        />
      </View>
