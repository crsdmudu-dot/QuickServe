/**
 * src/app/operations/index.tsx — Operations Portal: Cases List
 *
 ...
 *
 * Wrapped by AdminShell via the _layout.tsx — no Shell wrapper needed.
 *
...
import { DataTable, type Column } from '@admin/components/data-table';
import { PageMeta } from '@admin/components/page-meta';
import { CaseStatusBadge } from '@admin/components/operations/case-status-badge';
import { CasePriorityBadge } from '@admin/components/operations/case-priority-badge';
  ...
  return (
    <>
      <DataTable
        ...
        onRowPress={(c) =>
          router.push(`/operations/${c.id}` as Href)
        }
      />
    ...
    <>
      ...
      <View style={styles.newCaseRow}>
        <Button
          label="New case"
          variant="primary"
          onPress={() => router.push('/operations/new' as Href)}
        />
      </View>
