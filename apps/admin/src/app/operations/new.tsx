/**
 * src/app/operations/new.tsx — Operations Portal: Create Case
 *
...
import { CreateCaseForm } from '@admin/components/operations/create-case-form';
...
export default function AdminWebOperationsNewScreen() {
  ...
  function handleCreated(id: string) {
    router.replace(`/operations/${id}` as Href);
  }
