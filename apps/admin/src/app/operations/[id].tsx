/**
 * src/app/operations/[id].tsx — Operations Portal: Case Detail
 *
...
import { CaseTimeline } from '@admin/components/operations/case-timeline';
            ...
            <View style={styles.contextChipRow}>
              {caseData.booking_id ? (
                <Button
                  ...
                  variant="secondary"
                  onPress={() =>
                    router.push(`/bookings/${caseData.booking_id}` as Href)
                  }
                />
              ) : null}
              {caseData.provider_id ? (
                <Button
                  ...
                  variant="secondary"
                  onPress={() =>
                    router.push(`/providers/${caseData.provider_id}` as Href)
                  }
                />
              ) : null}
              {caseData.customer_id ? (
