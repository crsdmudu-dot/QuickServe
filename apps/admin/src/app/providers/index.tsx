/**
 * src/app/providers/index.tsx — Web Admin Providers List
 *
 ...
 *
 * Wrapped by AdminShell via _layout.tsx — no Shell wrapper here.
 *
  ...
  return (
    <>
      ...
      <DataTable
        ...
        onRowPress={(p) => router.push(`/providers/${p.id}` as Href)}
      />
    </>
  );
}
