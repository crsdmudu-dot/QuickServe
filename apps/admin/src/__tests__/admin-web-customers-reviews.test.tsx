 ...
 *   - src/app/customers/index.tsx  (read-only list)
 *   - src/app/reviews/index.tsx    (moderation with hide/unhide)
 *
...
import AdminWebCustomersScreen from '@admin/app/customers/index';
import AdminWebReviewsScreen from '@admin/app/reviews/index';
  ...
  it('pressing "Create case" navigates to operations/new with the customer id', async () => {
    ...
    await waitFor(() =>
      expect(router.push).toHaveBeenCalledWith(
        '/operations/new?customer_id=cust-aaaa-1111',
      ),
    );
  });
});
