 ...
 *   - src/app/payments/index.tsx
 *   - src/app/payment-attempts/index.tsx
 *   - src/app/earnings/index.tsx
 *
...
jest.mock('@admin/components/admin-provider-payout-panel', () => ({
...
import AdminWebPaymentsScreen from '@admin/app/payments/index';
import AdminWebPaymentAttemptsScreen from '@admin/app/payment-attempts/index';
import AdminWebEarningsScreen from '@admin/app/earnings/index';
  ...
  it('pressing "Create case" navigates to operations/new with the payment id', async () => {
    ...
    await waitFor(() =>
      expect(router.push).toHaveBeenCalledWith(
        '/operations/new?payment_id=pay1',
      ),
    );
  });
});
