...
jest.mock('@admin/components/charts/trend-card', () => ({
...
jest.mock('@admin/components/charts/bar-chart', () => ({
...
jest.mock('@admin/components/charts/line-chart', () => ({
...
jest.mock('@admin/components/charts/pie-chart', () => ({
...
import AdminWebAnalyticsScreen from '@admin/app/analytics/detailed';
