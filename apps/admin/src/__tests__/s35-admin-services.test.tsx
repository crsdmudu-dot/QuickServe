...
// services-catalog: the admin-only functions moved to the admin application's own module when they
// were split out of the shared @/lib/services-catalog; mock them where they now live.
jest.mock('@admin/lib/services-catalog-admin', () => ({
  listAdminServiceCategories: (...a: unknown[]) => mockListAdminServiceCategories(...a),
  listAdminServices:          (...a: unknown[]) => mockListAdminServices(...a),
  adminCreateCategory:        (...a: unknown[]) => mockAdminCreateCategory(...a),
  adminUpdateCategory:        (...a: unknown[]) => mockAdminUpdateCategory(...a),
...
import { ServiceStatusBadge } from '@admin/components/services/service-status-badge';
import { IconPicker }         from '@admin/components/services/icon-picker';
import { ColorPicker, COLOR_PALETTE } from '@admin/components/services/color-picker';
import { CategoryForm }       from '@admin/components/services/category-form';
import { ServiceForm }        from '@admin/components/services/service-form';
import AdminServicesScreen    from '@admin/app/services/index';
...
describe('AdminSidebar — Services entry', () => {
  ...
  it('navigates to /services when Services is pressed', () => {
    render(<AdminSidebar />);
