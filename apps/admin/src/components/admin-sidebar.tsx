...
const NAV_ITEMS: NavItem[] = [
  { label: 'Dashboard', route: '/dashboard', segment: 'dashboard' },
  { label: 'Bookings', route: '/bookings', segment: 'bookings' },
  { label: 'Providers', route: '/providers', segment: 'providers' },
  { label: 'Customers', route: '/customers', segment: 'customers' },
  { label: 'Payments', route: '/payments', segment: 'payments' },
  ...
  { label: 'Broadcast', route: '/broadcast', segment: 'broadcast' },
  { label: 'Promotions', route: '/promos', segment: 'promos' },
  { label: 'Analytics', route: '/analytics', segment: 'analytics' },
];
...
export function AdminSidebar({ orientation = 'side' }: AdminSidebarProps) {
   ...
   * segments array. Segment values are plain route names (e.g. "dashboard");
   * the former (admin-web) group prefix is gone, so no group name is compared
   * here.
   *
